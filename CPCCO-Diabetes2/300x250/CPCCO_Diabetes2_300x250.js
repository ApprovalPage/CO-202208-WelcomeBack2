...
lib.ssMetadata = [
		{name:"CPCCO_Diabetes2_300x250_atlas_NP_1", frames: [[0,0,600,500],[0,502,600,500],[0,1004,600,500],[0,1506,600,500]]}
];
...
(lib.CO_Diabetes2_300x250Checkup = function() {
	this.initialize(ss["CPCCO_Diabetes2_300x250_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.CPCCO_Diabetes2_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(150.15,231.85,0.21,0.21,0,0,0,0.7,56.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(416).to({_off:false},0).to({alpha:1},14).wait(2));

	// HEAD1
	this.instance_2 = new lib.HEAD1();
	this.instance_2.setTransform(150,171.05,1,1,0,0,0,0,24);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(63).to({alpha:0},7).wait(307).to({alpha:1},7).wait(48));
	...
	this.instance_5.setTransform(151,195,1,1,0,0,0,0,32);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(70).to({_off:false},0).to({alpha:1},7).wait(83).to({alpha:0},7).to({_off:true},1).wait(264));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(161).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.quadOut).wait(61).to({alpha:0},7).to({_off:true},1).wait(195));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(233).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.quadOut).wait(60).to({alpha:0},7).to({_off:true},1).wait(124));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(304).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.quadOut).wait(58).to({alpha:0},7).to({_off:true},1).wait(55));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(304).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.quadOut).wait(121));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(233).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.quadOut).to({_off:true},72).wait(120));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(161).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.quadOut).to({_off:true},73).wait(191));
...
p.nominalBounds = new cjs.Rectangle(149.5,123.9,300.5,126.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CPCCO_Diabetes2_300x250_atlas_NP_1.jpg?1660737972865", id:"CPCCO_Diabetes2_300x250_atlas_NP_1"}
	],
	preloads: []
};
