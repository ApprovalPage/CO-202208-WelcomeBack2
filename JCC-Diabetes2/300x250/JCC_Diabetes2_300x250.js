...
lib.ssMetadata = [
		{name:"JCC_Diabetes2_300x250_atlas_NP_1", frames: [[0,0,600,500],[0,502,600,500],[0,1004,600,500],[0,1506,600,500]]}
];
...
(lib.CO_Diabetes2_300x250Checkup = function() {
	this.initialize(ss["JCC_Diabetes2_300x250_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// type
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(36.625,2.65);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AggA7IAAhyIAeAAIAAAQQAFgIAKgFQAJgGALABIAAAdIgIgBIgIABIgIADIgHAEIgEAFIAABLg");
	this.shape_1.setTransform(27.075,2.5);
	...
	this.shape_2.setTransform(16.15,2.65);
	...
	this.shape_3.setTransform(5.025,2.65);
	...
	this.shape_4.setTransform(-9.675,1.225);
	...
	this.shape_5.setTransform(-19.525,2.65);
	...
	this.shape_6.setTransform(-34.1,0.475);
...
}).prototype = getMCSymbolPrototype(lib.CTA, new cjs.Rectangle(-82.8,-16.9,165.7,35), null);


// stage content:
(lib.JCC_Diabetes2_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/JCC_Diabetes2_300x250_atlas_NP_1.jpg?1660738337373", id:"JCC_Diabetes2_300x250_atlas_NP_1"}
	],
	preloads: []
};
