...
lib.ssMetadata = [
		{name:"JCC_Diabetes2_300x600_atlas_1", frames: [[0,0,600,1200],[602,0,600,1200],[1204,0,600,1200],[1806,0,600,1200]]}
];
...
(lib.CO_Diabetes2_300x600Checkup = function() {
	this.initialize(ss["JCC_Diabetes2_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.JCC_Diabetes2_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(142.1,455.95,1,1,0,0,0,-10.4,3.9);
	...
	this.instance_2.setTransform(150,329.05,1,1,0,0,0,0,24);
	...
	this.instance_3.setTransform(150,388.05,1,1,0,0,0,0,36);
	...
	this.instance_4.setTransform(151,386,1,1,0,0,0,0,32);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(161).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.quadOut).wait(61).to({alpha:0},7).to({_off:true},1).wait(195));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(233).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.quadOut).wait(60).to({alpha:0},7).to({_off:true},1).wait(124));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(304).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.quadOut).wait(58).to({alpha:0},7).to({_off:true},1).wait(55));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/JCC_Diabetes2_300x600_atlas_1.jpg?1660738316030", id:"JCC_Diabetes2_300x600_atlas_1"}
	],
	preloads: []
};
